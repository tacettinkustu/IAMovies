...
export const listItem =
  "flex flex-row gap-3 py-1 px-[10px] items-center w-full hover:text-black transition-all duration-300 font-nunito font-semibold ";

export const sideBarHeading =
  "xs:mb-[6px] mb-1 font-nunito font-bold  text-[15.75px] text-[#333]";

export const activeListItem = "text-black font-semibold";
